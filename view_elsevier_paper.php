...
$asd ="SELECT * FROM elsevier_content WHERE u_id ='$id1'";
        ...
        <main>            <section class="no-m blue4 text-white p-t-b-80">
                <div class="container">
                    <header class="p-t-50">
                        ...
                        <p class="s-24">Ready to download or edit your Elsevier Paper.</p>
                    </header>
                </div>
            </section>
            ...
            while($fetch=mysqli_fetch_assoc($view)){ 
               ...
               <a href="print_elsevier_details.php?id=<?php echo $fetch["id"]?>" style="color:red!important;"  target="_blank">PDF<img src="demos/html/paper-1.8.2/assets/img/pdf.png" alt="" style="height:42px;"></a> <hr></h4>
                        </div>
