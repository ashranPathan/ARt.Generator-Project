...
if(isset($_POST['upload']))
{
  ...
  $add="insert into content(project_title,author_name_1,author_name_2,author_name_3,author_name_4,abstract,keyword,
  introduction,parposed_system,conclusion,acknowledgment,reference,review_of_related_work,figures,u_id) 
  values('$project_title','$author_name_1','$author_name_2','$author_name_3','$author_name_4','$abstract',
  '$keyword','$introduction','$parposed_system','$conclusion','$acknowledgment','$reference',
  '$review_of_related_work','$photo','$id')";        
  $result=mysqli_query($connect,$add) or die(mysqli_error($connect));
  if($result)
  {
    echo "<script>";
    ...
    <div id="app" class="paper-loading">
        ...
        <div class="container">
                    <header class="p-t-30">
                        ...
                        <p class="s-24">Update your IEEE Paper.</p>
                    </header>
                </div>
            </section>
                    ...
                    <section class="p-t-b-50 s4 masonry-post">
                        <div class="container">
                            <header class="section-heading">
								<h1 class="s-54 font-weight-bolder text-center">View And Download Your Paper <small class="text-blue"></small></h1><br>  <a href="view_paper.php" class="btn btn-primary nav-btn" style="width:200px;">View paper</a><hr>
...
<?php
if (isset($_GET['u_id'])) {
  $abc=mysqli_query($connect,"select * from content where id='".$_GET['u_id']."'");

      while($fetch1=mysqli_fetch_array($abc)){
 
 ?>
                                        <form  method="POST" enctype="multipart/form-data">
                                            <div class="container">
                                            <div class="row">
                                                <div class="col-12 col-lg-12"> <label for="subject" class="required">Project Title</label> <input class="form-control form-control-lg" type="text" name="project_title" id="project_title" value="<?php echo $fetch1['project_title']; ?>"></div>
                                                 <div class="col-12 col-lg-12"> <label for="subject" class="required">Author Name 1</label> <input class="form-control form-control-lg" type="text" name="author_name_1" id="author_name_1" value="<?php echo $fetch1['author_name_1']; ?>"></div>
                                                 <div class="col-12 col-lg-12"> <label for="subject" class="required">Author Name 2</label> <input class="form-control form-control-lg" type="text" name="author_name_2" id="author_name_2" value="<?php echo $fetch1['author_name_2']; ?>"></div>
                                                   <div class="col-12 col-lg-12"> <label for="subject" class="required">Author Name 3</label> <input class="form-control form-control-lg" type="text" name="author_name_3" id="author_name_3" value="<?php echo $fetch1['author_name_3']; ?>"></div>
                                                     <div class="col-12 col-lg-12"> <label for="subject" class="required">Author Name 4</label> <input class="form-control form-control-lg" type="text" name="author_name_4" id="author_name_4" value="<?php echo $fetch1['author_name_4']; ?>"></div>
                                                <div class="col-12 col-lg-12">
                                                    <label for="message" class="required">Abstract</label><textarea placeholder="Abstract" name="abstract" id="abstract" class="form-control-lg" value="<?php echo $fetch1['abstract']; ?>"></textarea>
                                                </div>
                                                <div class="col-12 col-lg-12"> <label for="subject" class="required">keywords</label> <input class="form-control form-control-lg" type="text" name="keyword" id="keyword" value="<?php echo $fetch1['keyword']; ?>"></div>
                                                <div class="col-12 col-lg-12">
                                                    <label for="message" class="required">Introduction</label><textarea placeholder="introduction" name="introduction" id="introduction" class="form-control-lg" value="<?php echo $fetch1['introduction']; ?>"></textarea>
                                                </div>
                                                <div class="col-12 col-lg-12">
                                                    <label for="message" class="required">Exsisting System</label><textarea placeholder="introduction" name="exsisting_system" id="exsisting_system" class="form-control-lg" value="<?php echo $fetch1['exsisting_system']; ?>"></textarea>
                                                </div>
                                                <div class="col-12 col-lg-12">
                                                    <label for="message" class="required">Praposed System</label><textarea placeholder="Praposed System" name="parposed_system" id="parposed_system" class="form-control-lg" value="<?php echo $fetch1['parposed_system']; ?>"></textarea>
                                                </div>
                                                 <div class="col-12 col-lg-12">
                                                    <label for="message" class="required">Conclusion</label><textarea placeholder="conclusion" name="conclusion" id="conclusion" class="form-control-lg" value="<?php echo $fetch1['conclusion']; ?>"></textarea>
                                                </div>
                                                 <div class="col-12 col-lg-12">
                                                    <label for="message" class="required">Acknowledgment</label><textarea placeholder="Acknowledgment" name="acknowledgment" id="acknowledgment" class="form-control-lg" value="<?php echo $fetch1['acknowledgment']; ?>"></textarea>
                                                </div>
                                                <div class="col-12 col-lg-12">
                                                    <label for="message" class="required">References</label><textarea placeholder="References" name="reference" id="reference" class="form-control-lg" value="<?php echo $fetch1['reference']; ?>"></textarea>
                                                </div>
                                                <div class="col-12 col-lg-12">
                                                    <label for="message" class="required"> Review of Related Works </label>
                                                    <textarea placeholder=" Review of Related Works " name="review_of_related_work" id="review_of_related_work" class="form-control-lg" value="<?php echo $fetch1['review_of_related_work']; ?>"></textarea>
                                                </div>
                                                 <div class="col-12 col-lg-12">
                                                    <label for="message" class="required"> Figures</label>
                                                    <input type="file" placeholder="Figures and Tables" name="figures" 
                                                    id="figures" class="form-control-lg" value="<?php echo $fetch1['figures']; ?>">
                                                </div>
