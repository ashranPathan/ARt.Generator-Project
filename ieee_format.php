...
<script type="text/javascript">
    ...
    <div id="app" class="paper-loading">
        ...
        <main>            <section class="no-m blue4 text-white p-t-b-80">
                <div class="container">
                    <header class="p-t-30">
                        <h1 class="s-28 font-weight-bolder">Hey, <small class="text-blue">there</small></h1>
                        <p class="s-24">Ready to write your IEEE Paper.</p>
                    </header>
                </div>
            </section>
                    ...
                    <section class="p-t-b-50 s4 masonry-post">
                        <div class="container">
                            <header class="section-heading">
								<h1 class="s-34 font-weight-bolder text-center">View And Download Your Paper <small class="text-blue"></small></h1><br>  <a href="view_paper.php" class="btn btn-primary nav-btn" style="width:200px;">View paper</a><hr><br>
                                ...
                                <div class="col-lg-8" style="margin:auto">
                                    <div class="contactFormWrapper">
                                        ...
                                        <form  method="POST" enctype="multipart/form-data">
                                            <div class="container">
                                            <div class="row">
                                                <div class="col-12 col-lg-12"> <label for="subject" class="required">Project Title</label> <input class="form-control form-control-lg" placeholder="Enter Project Title" type="text" name="project_title" id="project_title"></div>
                                                 <div class="col-12 col-lg-12"> <label for="subject" class="required">Author Name 1</label> <input class="form-control form-control-lg" placeholder="Enter Author name" type="text" name="author_name_1" id="author_name_1"></div>
                                                 <div class="col-12 col-lg-12"> <label for="subject" class="required">Author Name 2</label> <input class="form-control form-control-lg" placeholder="Enter Author name" type="text" name="author_name_2" id="author_name_2"></div>
                                                   <div class="col-12 col-lg-12"> <label for="subject" class="required">Author Name 3</label> <input class="form-control form-control-lg" placeholder="Enter Author name" type="text" name="author_name_3" id="author_name_3"></div>
                                                     <div class="col-12 col-lg-12"> <label for="subject" class="required">Author Name 4</label> <input class="form-control form-control-lg" placeholder="Enter Author name" type="text" name="author_name_4" id="author_name_4"></div>
                                                <div class="col-12 col-lg-12">
                                                    <label for="message" class="required">Abstract</label><textarea placeholder="Enter Abstract" name="abstract" id="abstract" class="form-control-lg"></textarea>
                                                </div>
                                                <div class="col-12 col-lg-12"> <label for="subject" class="required">keywords</label> <input class="form-control form-control-lg" placeholder="Enter Keywords" type="text" name="keyword" id="keyword"></div>
                                                <div class="col-12 col-lg-12">
                                                    <label for="message" class="required">Introduction</label><textarea placeholder="Enter Introduction" name="introduction" id="introduction" class="form-control-lg"></textarea>
                                                </div>
                                                <div class="col-12 col-lg-12">
                                                    <label for="message" class="required">Exsisting System</label><textarea placeholder="Enter details about existing system" name="exsisting_system" id="exsisting_system" class="form-control-lg"></textarea>
                                                </div>
                                                <div class="col-12 col-lg-12">
                                                    <label for="message" class="required">Proposed System</label><textarea placeholder="Enter details Proposed System" name="parposed_system" id="parposed_system" class="form-control-lg"></textarea>
                                                </div>
                                                 <div class="col-12 col-lg-12">
                                                    <label for="message" class="required">Conclusion</label><textarea placeholder="Enter conclusion" name="conclusion" id="conclusion" class="form-control-lg"></textarea>
                                                </div>
                                                 <div class="col-12 col-lg-12">
                                                    <label for="message" class="required">Acknowledgment</label><textarea placeholder="Enter Acknowledgment" name="acknowledgment" id="acknowledgment" class="form-control-lg"></textarea>
                                                </div>
                                                <div class="col-12 col-lg-12">
                                                    <label for="message" class="required">References</label><textarea placeholder="Enter References" name="reference" id="reference" class="form-control-lg"></textarea>
                                                </div>
                                                <div class="col-12 col-lg-12">
                                                    <label for="message" class="required"> Review of Related Works </label>
                                                    <textarea placeholder="Enter Review of Related Works " name="review_of_related_work" id="review_of_related_work" class="form-control-lg"></textarea>
                                                </div>
                                                 <div class="col-12 col-lg-12">
